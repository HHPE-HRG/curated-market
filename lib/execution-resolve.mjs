 ...
 *
 * continuation_id on the request/identity is an opaque framework reference used
 * only to build Function Control binding keys / required affinity. This module
 * does not own Cursor Run objects, checkpoints, pending tools, or streams.
 */
