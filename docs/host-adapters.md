...
Living product specs: **agent-agnostic `main`** (`docs/superpowers/specs/2026-08-31-agent-agnostic-main-design.md`) vs **OpenCode-only** (`docs/superpowers/specs/2026-08-20-opencode-only-design.md` on `feat/opencode_only`). Index: `docs/superpowers/specs/README.md`.
